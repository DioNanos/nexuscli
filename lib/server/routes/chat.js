...
router.post('/', async (req, res) => {
  try {
    ...
    const { conversationId, message, model = 'sonnet', lane, runtimeId, workspace } = req.body;
    ...
    console.log(`[Chat] lane: ${runtimeSelection.lane}`);
    console.log(`[Chat] runtimeId: ${runtimeSelection.runtimeId}`);
    ...
    if (isEngineBridge) {
      ...
      console.log(`[Chat] Engine bridge detected: ${lastEngine} -> claude`);
      ...
      console.log(`[Chat] Prompt length: ${promptToSend.length} chars`);
