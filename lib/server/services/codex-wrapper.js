...
class CodexWrapper extends BaseCliWrapper {
   ...
   */
  async sendMessage({ prompt, model, threadId, reasoningEffort, workspacePath, imageFiles = [], onStatus, processId: processIdOverride, runtimeCommand, envOverrides = {} }) {
  ...
  handleExit(exitCode, stdout, parser, prompt, resolve, reject) {
    ...
    const threadId = typeof parser.getThreadId === 'function'
      ? parser.getThreadId()
      : null;
